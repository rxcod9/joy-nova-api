...
namespace Joy\NovaApi\Console\Commands;
...
class GenerateDocsCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'joy-nova-api:l5-swagger:generate {documentation?} {--all}';
    ...
    public function handle()
    {
        ...
        $this->generateNovaDocsJson();

        $this->mergePaths();
    }

    /**
     * Generate nova docs json.
     *
     * @return void
     */
    protected function generateNovaDocsJson()
    {
        $this->comment('Generating nova docs json');
        ...
        $openapi = new OpenApi([
            'openapi' => '3.0.2',
            'info'    => [
                'title'       => config('app.name', 'Joy Nova Api'),
                'description' => 'Joy NovaApi module adds REST Api end points to Nova with Passport and Swagger support https://github.com/rxcod9/joy-nova-api.',
                'version'     => '1.0.0',
            ],
            'servers' => [
                new Server([
    ...
    protected function paths(): array
    {
        ...
        // foreach (Nova::model('DataType')::all() as $dataType) {
    ...
    // {
    //     $name       = $dataType->name;
    //     $browseName = 'Nova' . Str::studly($dataType->name) . 'BrowseResource';
    ...
    // {
    //     $name       = $dataType->name;
    //     $browseName = 'Nova' . Str::studly($dataType->name) . 'CreateResource';
    ...
    //     $parameters = [];
    //     $name       = $dataType->slug;
    //     $readName   = 'Nova' . Str::studly($dataType->name) . 'ReadResource';
    ...
    //     $parameters = [];
    //     $name       = $dataType->slug;
    //     $editName   = 'Nova' . Str::studly($dataType->name) . 'ReadResource';
    ...
    //     $name       = $dataType->slug;
    //     $readName   = 'Nova' . Str::studly($dataType->name) . 'ReadResource';
    //     $storeName  = 'Nova' . Str::studly($dataType->name) . 'StoreRequest';
    ...
    //     $name       = $dataType->slug;
    //     $readName   = 'Nova' . Str::studly($dataType->name) . 'ReadResource';
    //     $updateName = 'Nova' . Str::studly($dataType->name) . 'UpdateRequest';
    ...
    //     $name             = $dataType->slug;
    //     $readName         = 'Nova' . Str::studly($dataType->name) . 'ReadResource';
    //     $singleUpdateName = 'Nova' . Str::studly($dataType->name) . 'SingleUpdateRequest';
    ...
    //     $browseName           = 'Nova' . Str::studly($dataType->name) . 'BrowseResource';
    //     $readName             = 'Nova' . Str::studly($dataType->name) . 'ReadResource';
    //     $filterName           = 'Nova' . Str::studly($dataType->name) . 'FilterRequest';
    ...
    //         if (in_array($row->type, config('nova.bread.column_filters.type_hidden', []))) {
    //             continue;
    //         }
    ...
    {
        $this->comment('Merging nova docs and api docs json');
